...
This taxonomy uses the concept of \emph{stacks} as a practical organizational framework, but it's important to understand what this represents. In reality, attention heads work in complex \emph{circuits}â€”groups of heads across multiple layers that cooperate to implement behaviors through multi-level processing \cite{elhage2021mathematical,wang2022interpretability}. 
