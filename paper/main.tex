...
\begin{figure}[htbp]
    ...
    \caption{Comprehensive overview of attention head types organized by functional stack (columns) and depth layer (row colors: Early=blue, Middle=green, Late=tan, Final=pink). Each cell shows the abbreviated head name and full name.}
    \label{fig:head-overview}
\end{figure}
